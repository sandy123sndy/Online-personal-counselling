...
<head>
    ...
    <title>Doctor's previous appointments</title>
    <style>
    img{
    	width: 100%;
    	height: 100%;
...
if(request.getParameter("b20")!=null){
	...
	PreparedStatement pst=con.prepareStatement("select * from prescription where prescription_id=? and doc_email_id_1=?");
	pst.setString(1, pid);
