...
if(email==null){
	...
	if(rs.next()){
		String name_1=rs.getString("doc_name");
}
}
...
<head>
    ...
    <title>Doctor after logged in</title>
    <style>
    img{
    	width: 100%;
    	height: 100%;
...
<body>
    ...
    <div><center><h1>Welcome doc!</h1></center></div>
<div class="grand">
    <div class="child" id="child_1">
        <div class="parent_1"><a href="my_appointment.jsp" ><img alt="" src="doc_3.jpg "></a></div>
        <div class="parent_2"><a href="doc_previous_appointments.jsp" ><img src="doc_2.jpg"></a></div>
    </div>
    <div class="child" id="child_2">
        <div class="parent_3"><a href="my_timing.jsp" ><img src="doc_4.jpg"></a></div>
        <div class="parent_4"><a href="make_a_prescription.jsp" ><img src="doc_5.jpg"></a></div>
    </div>
</div>   
